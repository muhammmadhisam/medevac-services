...
import { StationPatientOptionalDefaultsSchema } from "@/core/types/schema/prisma";
...
const ResponseSchema = SuccessResponseSchema(
  StationPatientOptionalDefaultsSchema,
);
const RequestBody = validator(
  "json",
  StationPatientOptionalDefaultsSchema.omit({
    create_date: true,
    id: true,
    out_date: true,
    patient_id: true,
...
const Docs = describeRoute({
  responses: {
    201: {
      ...
      description: "Create StationPatient",
    },
    500: {
      content: {
        "application/json": {
      ...
      description: "Create StationPatient Error",
    },
  },
  tags: ["StationPatient"],
});
